 ...
 * @version 1.0
 */
public class UserDAO implements BasicDAO<User, UserKey, NullKey> {
    ...
    @Override
    public List<User> getAll(NullKey referKey) throws DAOException {
        return this.getAll();
    }

    @Override
    public User get(UserKey key) throws DAOException {
        User user = new User();
        //Kiểm tra null
        if(connection == null) {
            throw new FailedExecuteException();
    ...
    @Override
    public User add(User user, UserKey key) throws DAOException {
    ...
    @Override
    public void update(User user, UserKey userKey) throws DAOException {
        this.update(user);
    }

    @Override
    public void delete(UserKey key) throws DAOException {
        //Kiểm tra null
        if(connection == null) {
            throw new FailedExecuteException();
        }
    ...
    @Override 
    public void deleteAll(NullKey referKey) throws DAOException {
        throw new FailedExecuteException();
    }
}